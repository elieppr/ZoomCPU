...
function listUpdateDomainsInCloudService() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.cloudServicesUpdateDomain.listUpdateDomains(resourceGroupName, cloudServiceName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
